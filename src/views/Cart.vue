            ...
            <div class="col">
              <div class="table-responsive">
                <table class="table">
                  <thead>
                    <tr>
                      <th scope="col" class="h5">Medicine</th>
                ...
                <div class="row">
                  <div class="col-lg-4 col-xl-3">
                    ...
                    >
                      ...
                      <p class="mb-2">{{ totalPrice }}Rupees</p>
                    </div>
          ...
          <div class="modal-body" style="display: flex">
            <div class="row g-0">
              ...
              <div class="col">
                <p
                  class="card-text"
                  style="margin-top: 62px; margin-left: 46px"
                >
